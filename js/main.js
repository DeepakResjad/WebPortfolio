...
document.addEventListener('DOMContentLoaded', function () {
    ...
    modeToggle.addEventListener('click', function () {
        toggleHeading.classList.toggle('dark-mode');
        toggleHeading.classList.toggle('light-mode');       
    });
});

document.addEventListener('DOMContentLoaded', function () {
    const modeToggle = document.getElementById('mode-toggle');
	const toggleElement = document.querySelector('.ftco-navbar-light .navbar-nav > .nav-item > .nav-link');
